...
mixin _$QuizSetModel {
 ...
 String get sourceTitle; List<QuizItemModel> get quizzes; DateTime get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QuizSetModel&&(identical(other.sourceTitle, sourceTitle) || other.sourceTitle == sourceTitle)&&const DeepCollectionEquality().equals(other.quizzes, quizzes)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sourceTitle,const DeepCollectionEquality().hash(quizzes),createdAt);

@override
String toString() {
  return 'QuizSetModel(sourceTitle: $sourceTitle, quizzes: $quizzes, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String sourceTitle, List<QuizItemModel> quizzes, DateTime createdAt
});
...
/// Create a copy of QuizSetModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sourceTitle = null,Object? quizzes = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String sourceTitle,  List<QuizItemModel> quizzes,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QuizSetModel() when $default != null:
return $default(_that.sourceTitle,_that.quizzes,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String sourceTitle,  List<QuizItemModel> quizzes,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _QuizSetModel():
return $default(_that.sourceTitle,_that.quizzes,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String sourceTitle,  List<QuizItemModel> quizzes,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _QuizSetModel() when $default != null:
return $default(_that.sourceTitle,_that.quizzes,_that.createdAt);case _:
  return null;
...
class _QuizSetModel implements QuizSetModel {
  const _QuizSetModel({required this.sourceTitle, required final  List<QuizItemModel> quizzes, required this.createdAt}): _quizzes = quizzes;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _QuizSetModel&&(identical(other.sourceTitle, sourceTitle) || other.sourceTitle == sourceTitle)&&const DeepCollectionEquality().equals(other._quizzes, _quizzes)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sourceTitle,const DeepCollectionEquality().hash(_quizzes),createdAt);
...
/// Create a copy of QuizSetModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sourceTitle = null,Object? quizzes = null,Object? createdAt = null,}) {
